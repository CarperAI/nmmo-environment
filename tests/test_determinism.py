...
# 50 is enough to test variety of agent actions
# if less than 20, agents won't trade 
TEST_HORIZON = 50
...
class TestDeterminism(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for t in tqdm(range(cls.horizon)):
            actions_src.append(serialize_actions(env_src.realm, env_src.actions))
        ...
        print('Running', cls.horizon, 'tikcs')
        for t in tqdm(range(cls.horizon)):
            actions_rep.append(serialize_actions(env_rep.realm, env_rep.actions))
